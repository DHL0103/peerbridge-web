...
export default function Repay() {
  ...
  return (
    <div style={{ background: T.bg, fontFamily: T.fSans, color: T.ink, paddingBottom: 80 }}>
      ...
      {loadError && (
        <div style={{ margin: '0 56px', padding: 20, background: T.card, borderRadius: T.rLg, fontSize: 13, color: '#c0392b' }}>{loadError}</div>
      )}

      {!loadError && next === null && (
        <div style={{ margin: '0 56px', padding: 40, background: T.card, borderRadius: T.rLg, textAlign: 'center' }}>
