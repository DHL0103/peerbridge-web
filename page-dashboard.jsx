    ...
    <div style={{ width: 1440, background: T.bg, fontFamily: T.fSans, color: T.ink, paddingBottom: 80 }}>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={{ flex: 1, padding: '32px 56px 0 0' }}>
          <div style={{ fontSize: 13, color: T.ink2, marginBottom: 8 }}>김지영님, 안녕하세요</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: T.gap, marginTop: T.gap }}>
            ...
            <div style={{ background: T.card, borderRadius: T.rLg, padding: 32 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {[
                  ['11.25', '강남 역삼동 오피스텔', '+78,300원'],
                  ['11.25', '의료기기 매출채권 24-11호', '+34,200원'],
                  ['11.30', '판교 아파트 후순위', '+54,900원'],
                  ['12.05', '용산 상가 리파이낸싱', '+89,500원'],
                ].map(([d, t, v], i, a) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 0', borderBottom: i < a.length - 1 ? `1px solid ${T.line}` : 'none' }}>
                    <div style={{ width: 44, textAlign: 'center', fontFamily: T.fDisp, fontSize: 13, fontWeight: 600, color: T.ink }}>{d}</div>
                    <div style={{ flex: 1, fontSize: 13, color: T.ink, lineHeight: 1.4 }}>{t}</div>
          ...
          <div style={{ background: T.card, borderRadius: T.rLg, padding: 32, marginTop: T.gap }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 13, color: T.ink2 }}>전체 보기 →</span>
            </div>
...
function DashStat({ k, v, unit, sub, accent }) {
  return (
